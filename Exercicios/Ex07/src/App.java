...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        float notas100, notas50, notas20, notas10, notas5;
        ...
        valor = valor % 5;
        if (notas100 > 0){
            System.out.println((int)notas100 + " nota(s) de 100 euros.");
        }
        if (notas50 > 0){
            System.out.println((int)notas50 + " nota(s) de 50 euros.");
        }
        if (notas20 > 0){
            System.out.println((int)notas20 + " nota(s) de 20 euros.");
        }
        if (notas10 > 0){
            System.out.println((int)notas10 + " nota(s) de 10 euros.");
        }
        if (notas5 > 0){
            System.out.println((int)notas5 + " nota(s) de 5 euros.");
        }
        input.close();
